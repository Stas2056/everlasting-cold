...
label SirVilat:
    ...
    # {w}text   -слово текст печатается не сразу  
    # {i}{/i} -курсив
...
# Очнулся в автобусе
    ...
    "Только и сказал я."
    th "Нет, я конечно мечтал попасть на место дауна-Семена, но как-то не особо был к этому готов. С другой стороны, это место было мне как родное и вряд ли чем-то удивит, да и бояться нечего" 
...
# Вышел, увидел Семена   
    ...
    with vpunch
    stop ambience
    "Без лишних раздумий я смачно пнул ДЦПщника по хребту и отскочил за один из постаментов"
    scene cg d6_pioneer
...
# Славя пришла    Не-настолько-треш коммит
    ...
    я "Ладно, всё-равно ничего страшного я не сделал. Иди сюда, жертва избиения!"
...
# Вернулись полным составом к воротам
    ...
    th "И не успел Семён задать какой-нибудь из своих дурацких вопросов, как Славя скрылась за воротами. Как же она всё-таки мила! Даже к этому юродивому так хорошо относится."
    я "Пошли!"
